...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='BEB-001' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,48,12,NOW(),NOW());
  END IF;
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='BEB-002' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,24,6,NOW(),NOW());
  END IF;
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='BEB-003' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,60,24,NOW(),NOW());
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='LAC-002' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,30,10,NOW(),NOW());
  END IF;
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='LAC-003' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,20,5,NOW(),NOW());
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='LIM-001' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,15,5,NOW(),NOW());
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='HIG-001' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,12,3,NOW(),NOW());
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM "Product" WHERE sku='CON-001' AND "tenantId"=v_tenant_id) THEN
    ...
    INSERT INTO "InventoryLevel" (id,"productId","branchId",quantity,"minStock","createdAt","updatedAt") VALUES (gen_random_uuid()::TEXT,p_id,v_branch_id,10,3,NOW(),NOW());
  END IF;
