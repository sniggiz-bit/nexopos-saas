                ...
                <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                        <div className="flex justify-between items-center">
                            ...
                            <span>{formatPrice(Number(closedShift.expectedAmount))}</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="font-medium">Monto Declarado:</span>
                            <span>{formatPrice(Number(closedShift.finalAmount))}</span>
                        </div>
                        <div className="flex justify-between items-center pt-2 border-t">
                            <span className="font-bold">Diferencia:</span>
                            <span className={`font-bold ${Number(closedShift.difference) < 0 ? 'text-red-500' : 'text-green-600'}`}>
                                {formatPrice(Number(closedShift.difference))}
                            </span>
                        </div>
                    </div>
                    <DialogFooter>
