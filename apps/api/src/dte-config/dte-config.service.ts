...
export class DteConfigService {
    ...
    async upsert(createDteConfigDto: CreateDteConfigDto): Promise<DteConfigResponseDto> {
    ...
    async update(id: string, updateDteConfigDto: UpdateDteConfigDto): Promise<DteConfigResponseDto> {
