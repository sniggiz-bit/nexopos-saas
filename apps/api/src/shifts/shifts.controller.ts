...
export class ShiftsController {
    ...
    @Post('open')
    async openShift(@Body() body: { branchId: string; initialAmount: number; userId: string; tenantId: string }) {
    ...
    @Post('close')
    async closeShift(@Body() body: { shiftId: string; userId: string; finalAmount: number }) {
